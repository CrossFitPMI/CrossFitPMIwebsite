...
export default function WhatsAppChatButton() {
  ...
  return (
    <button
      onClick={handleClick}
      className={`fixed bottom-6 right-6 z-50 bg-[#25D366] hover:bg-[#20b659] text-white rounded-full p-4 shadow-2xl transition-all duration-500 transform hover:scale-110 active:scale-95 group ${
